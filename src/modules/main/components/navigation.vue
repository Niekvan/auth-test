<template>
  <nav class="nav">
    ...
    <router-link to="/dashboard" class="nav__link" exact
      ><b-icon icon="analytics" class="nav__icon"></b-icon
      ><span>Dashboard</span></router-link
    >
    <router-link to="/bookings" class="nav__link" exact
      ><b-icon icon="schedule" class="nav__icon"></b-icon
      ><span>Bookings</span></router-link
    >
    <router-link to="/accounting" class="nav__link" exact
      ><b-icon icon="credit-card" class="nav__icon"></b-icon
      ><span>Accouting</span></router-link
    >
    <router-link to="/profile" class="nav__link" exact
      ><b-icon icon="user" class="nav__icon"></b-icon
...
.nav {
  ...
  width: 15rem;
  padding: 1rem 0;
  // background: map-get($custom-colors, 'primary-lighter');
  color: $primary-dark;
